       SUBROUTINE WLECVONEMC (YDATA,XDATA,INTER,NSIZE,NVAR,
     & NMCCV,IMODEL,NSPLIT,DPESI,
     & dcv,zparam,dsigma,info)
...
C     IMODEL    input    I      1
C     dcv       output   D      NMCCV                MC values
C     zparam    output   D      (NMCCV,NVAR+INTER)   MC values
C     dsigma    output   D      NMCCV                MC values
C     info      output   I      1
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      dimension zparam(nmccv,nvar+inter)
      dimension dsigma(nmccv)
